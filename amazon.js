...
(async () => {
  ...
  while (!isBtnDisabled) {
    ...
    await page.waitForSelector(" .s-pagination-disabled", { visible: true });
    const is_disabled = (await page.$(".s-pagination-item .s-pagination-selected  ")) !== null;
